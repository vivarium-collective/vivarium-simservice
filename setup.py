...
with open("README.md", "r") as readme:
    ...
    description2 = re.sub(
        r']\(([\w/.-]+\.png)\)',
        r'](https://github.com/vivarium-collective/vivarium-simservice/raw/main/\1)',
        description)
    long_description = re.sub(
        r']\(([\w/.-]+)\)',
        r'](https://github.com/vivarium-collective/vivarium-simservice/blob/main/\1)',
        description2)
...
setup(
    ...
    url="https://github.com/vivarium-collective/vivarium-simservice",
